...
from scrap_elements import (find_element_and_click, extract_elements, build_recipes_links,
                            get_recipe)
...
driver.close()
driver.quit()
country_url = extract_country(cuisines_list)
recipes_links = build_recipes_links(country_url, HEADERS, target_country="Spanish")
#recipes_links = build_recipes_links(country_url, HEADERS)
